...
class DirectDraw4 : public interface::DirectDraw4, public Unknown<Final>
{
    Final & getFinal()
    {
...
public:
    ...
    virtual __stdcall HRESULT CreateSurface(LPDDSURFACEDESC2 arg1, interface::DirectDrawSurface4 * FAR * arg2, IUnknown FAR * arg3) override final
    {
        return getFinal().createSurface(arg1, arg2, arg3);
    }

    virtual __stdcall HRESULT DuplicateSurface(interface::DirectDrawSurface4 * arg1, interface::DirectDrawSurface4 * FAR * arg2) override final
    {
    ...
    virtual __stdcall HRESULT GetGDISurface(interface::DirectDrawSurface4 * FAR * arg) override final
    {
    ...
    virtual __stdcall HRESULT GetSurfaceFromDC(HDC arg1, interface::DirectDrawSurface4 ** arg2) override final
    {
    ...
    virtual __stdcall HRESULT GetDeviceIdentifier(LPDDDEVICEIDENTIFIER arg1, DWORD arg2) override final
    {
