...
public:
    virtual __stdcall HRESULT AddAttachedSurface(interface::DirectDrawSurface7 * arg) override final
    {
    ...
    virtual __stdcall HRESULT Blt(LPRECT arg1, interface::DirectDrawSurface7 * arg2, LPRECT arg3, DWORD arg4, LPDDBLTFX arg5) override final
    {
    ...
    virtual __stdcall HRESULT BltFast(DWORD arg1, DWORD arg2, interface::DirectDrawSurface7 * arg3, LPRECT arg4, DWORD arg5) override final
    {
        return getFinal().bltFast(arg1, arg2, arg3, arg4, arg5);
    }

    virtual __stdcall HRESULT DeleteAttachedSurface(DWORD arg1, interface::DirectDrawSurface7 * arg2) override final
    {
    ...
    virtual __stdcall HRESULT Flip(interface::DirectDrawSurface7 * arg1, DWORD arg2) override final
    {
        return getFinal().flip(arg1, arg2);
    }

    virtual __stdcall HRESULT GetAttachedSurface(LPDDSCAPS2 arg1, interface::DirectDrawSurface7 * FAR * arg2) override final
    {
    ...
    virtual __stdcall HRESULT UpdateOverlay(LPRECT arg1, interface::DirectDrawSurface7 * arg2, LPRECT arg3, DWORD arg4, LPDDOVERLAYFX arg5) override final
    {
    ...
    virtual __stdcall HRESULT UpdateOverlayZOrder(DWORD arg1, interface::DirectDrawSurface7 * arg2) override final
    {
