...
class DirectDraw7 : public interface::DirectDraw7, public Unknown<Final>
{
    Final & getFinal()
    {
...
public:
    ...
    virtual __stdcall HRESULT CreateSurface(LPDDSURFACEDESC2 arg1, interface::DirectDrawSurface7 * FAR * arg2, IUnknown FAR * arg3) override final
    {
        return getFinal().createSurface(arg1, arg2, arg3);
    }

    virtual __stdcall HRESULT DuplicateSurface(interface::DirectDrawSurface7 * arg1, interface::DirectDrawSurface7 * FAR * arg2) override final
    {
        return getFinal().duplicateSurface(arg1, arg2);
    }

    virtual __stdcall HRESULT EnumDisplayModes(DWORD arg1, LPDDSURFACEDESC2 arg2, LPVOID arg3, LPDDENUMMODESCALLBACK2 arg4) override final
    {
        return getFinal().enumDisplayModes(arg1, arg2, arg3, arg4);
    }

    virtual __stdcall HRESULT EnumSurfaces(DWORD arg1, LPDDSURFACEDESC2 arg2, LPVOID arg3, EnumSurfacesCallback arg4) override final
    {
    ...
    virtual __stdcall HRESULT GetDisplayMode(LPDDSURFACEDESC2 arg) override final
    {
    ...
    virtual __stdcall HRESULT GetGDISurface(interface::DirectDrawSurface7 * FAR * arg) override final
    {
    ...
    virtual __stdcall HRESULT GetAvailableVidMem(LPDDSCAPS2 arg1, LPDWORD arg2, LPDWORD arg3) override final
    {
        return getFinal().getAvailableVidMem(arg1, arg2, arg3);
    }

    virtual __stdcall HRESULT GetSurfaceFromDC(HDC arg1, interface::DirectDrawSurface7 ** arg2) override final
    {
        return getFinal().getSurfaceFromDC(arg1, arg2);
    }

    virtual __stdcall HRESULT RestoreAllSurfaces() override final
    {
        return getFinal().restoreAllSurfaces();
    }

    virtual __stdcall HRESULT TestCooperativeLevel() override final
    {
        return getFinal().testCooperativeLevel();
    }

    virtual __stdcall HRESULT GetDeviceIdentifier(LPDDDEVICEIDENTIFIER2 arg1, DWORD arg2) override final
    {
        return getFinal().getDeviceIdentifier(arg1, arg2);
    }

    virtual __stdcall HRESULT StartModeTest(LPSIZE arg1, DWORD arg2, DWORD arg3) override final
    {
        return getFinal().startModeTest(arg1, arg2, arg3);
    }

    virtual __stdcall HRESULT EvaluateMode(DWORD arg1, DWORD * arg2) override final
    {
        return getFinal().evaluateMode(arg1, arg2);
    }
};
