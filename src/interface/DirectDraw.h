...
class DirectDraw : virtual public Unknown
{
public:
    ...
    virtual __stdcall HRESULT EnumDisplayModes(DWORD arg1, SurfaceDescription * arg2, LPVOID arg3, LPDDENUMMODESCALLBACK arg4) = 0;
    ...
    virtual __stdcall HRESULT SetDisplayMode(DWORD arg1, DWORD arg2, DWORD arg3) = 0;
