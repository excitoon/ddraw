...
class DirectDrawSurface4 : virtual public Unknown
{
public:
    using EnumSurfacesCallback = __stdcall PASCAL HRESULT (*)(DirectDrawSurface4 *, DDSURFACEDESC2 *, void *);

    virtual __stdcall HRESULT AddAttachedSurface(DirectDrawSurface4 * arg) = 0;
    virtual __stdcall HRESULT AddOverlayDirtyRect(LPRECT arg) = 0;
    virtual __stdcall HRESULT Blt(LPRECT arg1, DirectDrawSurface4 * arg2, LPRECT arg3, DWORD arg4, LPDDBLTFX arg5) = 0;
    virtual __stdcall HRESULT BltBatch(LPDDBLTBATCH arg1, DWORD arg2, DWORD arg3) = 0;
    virtual __stdcall HRESULT BltFast(DWORD arg1, DWORD arg2, DirectDrawSurface4 * arg3, LPRECT arg4, DWORD arg5) = 0;
    virtual __stdcall HRESULT DeleteAttachedSurface(DWORD arg1, DirectDrawSurface4 * arg2) = 0;
    ...
    virtual __stdcall HRESULT Flip(DirectDrawSurface4 * arg1, DWORD arg2) = 0;
    virtual __stdcall HRESULT GetAttachedSurface(LPDDSCAPS2 arg1, DirectDrawSurface4 * FAR * arg2) = 0;
    virtual __stdcall HRESULT GetBltStatus(DWORD arg) = 0;
    virtual __stdcall HRESULT GetCaps(LPDDSCAPS2 arg) = 0;
    ...
    virtual __stdcall HRESULT GetSurfaceDesc(LPDDSURFACEDESC2 arg) = 0;
    virtual __stdcall HRESULT Initialize(LPDIRECTDRAW arg1, LPDDSURFACEDESC2 arg2) = 0;
    virtual __stdcall HRESULT IsLost() = 0;
    virtual __stdcall HRESULT Lock(LPRECT arg1, LPDDSURFACEDESC2 arg2, DWORD arg3, HANDLE arg4) = 0;
    ...
    virtual __stdcall HRESULT UpdateOverlay(LPRECT arg1, DirectDrawSurface4 * arg2, LPRECT arg3, DWORD arg4, LPDDOVERLAYFX arg5) = 0;
    virtual __stdcall HRESULT UpdateOverlayDisplay(DWORD arg) = 0;
    virtual __stdcall HRESULT UpdateOverlayZOrder(DWORD arg1, DirectDrawSurface4 * arg2) = 0;
    ...
    virtual __stdcall HRESULT SetSurfaceDesc(LPDDSURFACEDESC2 arg1, DWORD arg2) = 0;
