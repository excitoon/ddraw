...
class DirectDrawSurface3 : virtual public Unknown
{
public:
    using EnumSurfacesCallback = __stdcall PASCAL HRESULT (*)(DirectDrawSurface3 *, DDSURFACEDESC *, void *);

    virtual __stdcall HRESULT AddAttachedSurface(DirectDrawSurface3 * arg) = 0;
    virtual __stdcall HRESULT AddOverlayDirtyRect(LPRECT arg) = 0;
    virtual __stdcall HRESULT Blt(LPRECT arg1, DirectDrawSurface3 * arg2, LPRECT arg3, DWORD arg4, LPDDBLTFX arg5) = 0;
    virtual __stdcall HRESULT BltBatch(LPDDBLTBATCH arg1, DWORD arg2, DWORD arg3) = 0;
    virtual __stdcall HRESULT BltFast(DWORD arg1, DWORD arg2, DirectDrawSurface3 * arg3, LPRECT arg4, DWORD arg5) = 0;
    virtual __stdcall HRESULT DeleteAttachedSurface(DWORD arg1, DirectDrawSurface3 * arg2) = 0;
    ...
    virtual __stdcall HRESULT Flip(DirectDrawSurface3 * arg1, DWORD arg2) = 0;
    virtual __stdcall HRESULT GetAttachedSurface(LPDDSCAPS arg1, DirectDrawSurface3 * FAR * arg2) = 0;
    ...
    virtual __stdcall HRESULT UpdateOverlay(LPRECT arg1, DirectDrawSurface3 * arg2, LPRECT arg3, DWORD arg4, LPDDOVERLAYFX arg5) = 0;
    virtual __stdcall HRESULT UpdateOverlayDisplay(DWORD arg) = 0;
    virtual __stdcall HRESULT UpdateOverlayZOrder(DWORD arg1, DirectDrawSurface3 * arg2) = 0;
    ...
    virtual __stdcall HRESULT SetSurfaceDesc(LPDDSURFACEDESC arg1, DWORD arg2) = 0;
};
