...
public:
    ...
    using EnumSurfacesCallback = __stdcall PASCAL HRESULT (*)(DirectDrawSurface3 *, SurfaceDescription *, void *);
    ...
    virtual __stdcall HRESULT GetAttachedSurface(SurfaceCapabilities * arg1, DirectDrawSurface3 * FAR * arg2) = 0;
