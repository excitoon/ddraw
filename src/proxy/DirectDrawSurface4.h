...
class DirectDrawSurface4 : public interface::DirectDrawSurface4, public Unknown<Final>
{
    Final & getFinal()
    {
...
public:
    virtual __stdcall HRESULT AddAttachedSurface(interface::DirectDrawSurface4 * arg) override final
    {
    ...
    virtual __stdcall HRESULT Blt(LPRECT arg1, interface::DirectDrawSurface4 * arg2, LPRECT arg3, DWORD arg4, LPDDBLTFX arg5) override final
    {
    ...
    virtual __stdcall HRESULT BltFast(DWORD arg1, DWORD arg2, interface::DirectDrawSurface4 * arg3, LPRECT arg4, DWORD arg5) override final
    {
        return getFinal().bltFast(arg1, arg2, arg3, arg4, arg5);
    }

    virtual __stdcall HRESULT DeleteAttachedSurface(DWORD arg1, interface::DirectDrawSurface4 * arg2) override final
    {
    ...
    virtual __stdcall HRESULT Flip(interface::DirectDrawSurface4 * arg1, DWORD arg2) override final
    {
        return getFinal().flip(arg1, arg2);
    }

    virtual __stdcall HRESULT GetAttachedSurface(LPDDSCAPS2 arg1, interface::DirectDrawSurface4 * FAR * arg2) override final
    {
    ...
    virtual __stdcall HRESULT GetCaps(LPDDSCAPS2 arg) override final
    {
    ...
    virtual __stdcall HRESULT GetSurfaceDesc(LPDDSURFACEDESC2 arg) override final
    {
        return getFinal().getSurfaceDesc(arg);
    }

    virtual __stdcall HRESULT Initialize(LPDIRECTDRAW arg1, LPDDSURFACEDESC2 arg2) override final
    {
    ...
    virtual __stdcall HRESULT Lock(LPRECT arg1, LPDDSURFACEDESC2 arg2, DWORD arg3, HANDLE arg4) override final
    {
    ...
    virtual __stdcall HRESULT UpdateOverlay(LPRECT arg1, interface::DirectDrawSurface4 * arg2, LPRECT arg3, DWORD arg4, LPDDOVERLAYFX arg5) override final
    {
    ...
    virtual __stdcall HRESULT UpdateOverlayZOrder(DWORD arg1, interface::DirectDrawSurface4 * arg2) override final
    {
    ...
    virtual __stdcall HRESULT SetSurfaceDesc(LPDDSURFACEDESC2 arg1, DWORD arg2) override final
    {
