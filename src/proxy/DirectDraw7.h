...
public:
    using Interface = interface::DirectDraw7;
    ...
    virtual __stdcall HRESULT EnumDisplayModes(DWORD arg1, SurfaceDescription * arg2, LPVOID arg3, LPDDENUMMODESCALLBACK2 arg4) override final
    {
    ...
    virtual __stdcall HRESULT GetSurfaceFromDC(HDC arg1, Surface ** arg2) override final
    {
